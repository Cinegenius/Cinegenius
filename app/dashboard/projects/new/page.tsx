...
const TYPE_CONFIG: Record<string, TypeConfig> = {
  ...
  "Event / Live": { rolePlaceholder: "z. B. Kameramann, Live-Cutter, Tonmeister", directorLabel: "Veranstaltungsort", directorPlaceholder: "z. B. Olympiastadion, Messe Hamburg", genreLabel: "Art des Events", genrePlaceholder: "Konzert, Festival, Konferenz, Messe …", locationLabel: "Stadt / Region", locationPlaceholder: "z. B. Berlin, München, Wien", companyLabel: "Veranstalter / Auftraggeber", companyPlaceholder: "z. B. Live Nation, Eventfirma", linkPlaceholder: "YouTube, Instagram, Event-Website …", descPlaceholder: "Welches Event wurde gefilmt? Was war besonders daran?", titlePlaceholder: "z. B. Rock am Ring 2024 – Backstage" },
